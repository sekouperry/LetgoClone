...
class addPostViewController1: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    //switch control for label to appear
