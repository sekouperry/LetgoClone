...
class SignUpViewController: UIViewController,  UITextFieldDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverPresentationControllerDelegate  {
        ...
        if finalEmail.isEmpty || password.isEmpty || reenterPassword.isEmpty || firstname.isEmpty || lastname.isEmpty {
            ...
            if password == reenterPassword {
                ...
                if isValidEmail(email: finalEmail) {
                    self.networkingService.signUp(firstname: firstname, lastname: lastname, email: finalEmail, pictureData: data, password: password)
                }
