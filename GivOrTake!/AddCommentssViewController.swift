//
//  AddCommentssViewController.swift
//  GivOrTake!
//
...
class AddCommentssViewController: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func saveComment(_ sender: CustomizableButtons){
