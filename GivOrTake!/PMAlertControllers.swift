...
@objc open class PMAlertControllers: UIViewController {
    ...
    //MARK: - Actions
    @objc open func addAction(_ alertAction: PMAlertActions){
        ...
        alertAction.addTarget(self, action: #selector(PMAlertControllers.dismissAlertController(_:)), for: .touchUpInside)
        
    }
    
    @objc fileprivate func dismissAlertController(_ sender: PMAlertActions){
